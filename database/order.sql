...
CREATE TABLE customer (
    user_id INT PRIMARY KEY AUTO_INCREMENT,
    CONSTRAINT customer_ibfk FOREIGN KEY (user_id) REFERENCES userR(user_id)
);
...
CREATE TABLE Report (
    ...
    UserID INT,
    FOREIGN KEY (Shop_ID) REFERENCES shop(shop_id),
    FOREIGN KEY (UserID) REFERENCES userR(user_id)
);
...
INSERT INTO userR (user_id, username, password, email, phone_number, role, created_at, updated_at) VALUES
...
-- Order table
INSERT INTO `order` (order_id, total_amount, order_date, status, user_id, shop_id) VALUES
...
INSERT INTO order_item (order_item_id, order_id, product_id, quantity, unit_price, subtotal) VALUES
    ...
    (12, 1011, 11, 1, 25997.00, 25997.00),                                                                                             (13, 1012, 13, 1, 5000.00, 5000.00),
...
# --  Create Report
# INSERT INTO report (report_id,report_type, generated_date, format, report_data, period_start, period_end, user_id,report_name,report_description,product_categories,order_statuses,shop_id) VALUES
# --  Create Shop-Report
# INSERT INTO shop_report (shop_id, report_id) VALUES
