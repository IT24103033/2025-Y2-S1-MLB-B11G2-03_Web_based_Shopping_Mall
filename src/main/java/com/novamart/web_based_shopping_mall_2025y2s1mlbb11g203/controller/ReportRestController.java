...
public class ReportRestController {
    ...
    public ResponseEntity<?> generateSalesReport(
        ...
        try {
            ...
            // Add shop info to report name and description
            String finalReportName = reportName + " - Shop " + shopId;
            String finalReportDescription;
            ...
            Map<String, Object> response = new HashMap<>();
            response.put("success", true);
            response.put("message", "Sales report generated successfully for Shop " + shopId + "!");
            response.put("report", savedReport);
